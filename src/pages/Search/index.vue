              ...
              <ul class="sui-nav">
                <li :class="{active:isOne}" @click="changeOrder('1')">
                  <a>综合
                    <span v-show="isOne"
                          class="iconfont"
                          :class="{'icon-xiangshangjiantoucuxiao':isAsc,'icon-xiangxiajiantoucuxiao':isDesc}">
                    </span>
                  </a>
                </li>
            ...
            <ul class="yui3-g">
              <li class="yui3-u-1-5" v-for="(good,index) in goodsList" :key="good.id">
                <div class="list-wrap">
                  ...
                  <div class="attr">
                    <a target="_blank" href="item.html" title="促销】">
                      {{ good.title }}
                    </a>
                  </div>
                  <div class="commit">
...
export default {
  ...
  computed: {
    //mapGetters里面的写法：传递的是数组，因为getters计算式没有划分模块
  ...
  methods: {
    ...
    //删除分类的名字
    removeCategoryName() {
      //带给服务器的数据都是可有可无的：如果属性值为空的字符串还是回吧相应的字段带给服务器
      ...
      //本意是：删除query参数，路径中如果有params参数不应该删除,路由跳转的时候应该带着
    ...
    changeOrder(flag) {
      ...
      let oiginOrder = this.searchParams.order;
      //这里获取到的是起始的状态
